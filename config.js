...
/*============== NOMOR ==============*/
global.nomorbot = '6285749710086'
global.nomorown = '6281231319880'
global.namebot = 'maxsBotz'
global.nameown = 'mxs'


/*============== STAFF ==============*/
global.owner = [
  ['6281231319880', 'mxs', 'true']
...
/*============== WATERMARK ==============*/
global.wm = 'By MAXSBotz' //Main Watermark
global.wm2 = 'MXS'
global.wm3 = 'MAXSBotz | ByMXS'
global.botdate = `⻝ 𝗗𝗮𝘁𝗲: ${week} ${date}\n⻝ 𝗧𝗶𝗺𝗲: ${wktuwib}`
global.bottime = `⻝ 𝗧 𝗜 𝗠 𝗘 : ${wktuwib}`
global.titlebot = `MAXSBotz | ʙʏ ${global.nameown}`
global.author = 'MXS' 
global.packname = 'MXS'
...
/*============== GLOBAL BIO ==============*/
global.nameowner = 'MSX'
global.umurowner = '18'
global.asalowner = 'Jawa Barat, Kuningan'
global.nomorowner = 'X'
global.pacarowner = 'XS'
...
/*============== STICKER WM ==============*/
global.stickpack = 'ByMAXSBotz'
global.stickauth = `MXS`
